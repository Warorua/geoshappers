...
class Skin_Carmie extends Elementor_Skin_Base {
	...
	public function _register_controls_actions() {
		...
		//add_action( 'elementor/element/bdt-post-grid/section_content_layout/after_section_start', [ $this, 'register_carmie_grid_controls'   ] );

	}

	public function register_carmie_grid_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'5' => esc_html__( 'Five', 'bdthemes-element-pack' ),
				],
			]
		);
	}
