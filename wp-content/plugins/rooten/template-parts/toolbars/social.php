...
if (count($links)) : ?>
	<div class="social-link">
		<ul<?php echo rooten_helper::attrs($attrs_grid) ?>>
		    ...
		    <li>
		        <a<?php echo rooten_helper::attrs(['href' => $link], $attrs); ?> bdt-icon="icon: <?php echo rooten_helper::icon($link); ?>; ratio: 0.8" title="<?php echo ucfirst(rooten_helper::icon($link)); ?>" bdt-tooltip="pos: bottom"></a>
		    </li>
		    <?php endforeach ?>
		</ul>
	</div>
