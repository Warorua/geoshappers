    ...
    **/
    $ul  =  $li->find('ul')->item(0);
        ...
        if( (int) $li->attr('full_width') == 1){            
            ...
            $li->append(sprintf('<div  class="bdt-navbar-dropdown"%s><div class="bdt-navbar-dropdown-grid bdt-grid-divider bdt-child-width-1-%d@s" bdt-grid=""></div></div>', $style, $columns));
            ...
            // append dropdown divs
            $li->append(sprintf('<div  class="bdt-navbar-dropdown"%s><div class="bdt-container"><div class="bdt-navbar-dropdown-grid bdt-grid-divider bdt-child-width-1-%d@s" bdt-grid=""></div></div></div>', $style, $columns));
